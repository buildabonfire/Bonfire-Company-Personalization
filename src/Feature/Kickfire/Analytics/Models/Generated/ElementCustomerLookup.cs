...
{
    [Serializable]
    internal class ElementCustomerLookup : Element, IElementCustomerLookup, IElement, IValidatable
    {
        ...
        private const string FieldModified = "Modified";
        ...
        public ElementCustomerLookup()
        {
            ...
            base.EnsureAttribute<DateTime>(FieldConfidence);
        }
        ...
        {
            get { return base.GetAttribute<DateTime>(FieldModified); }
            set { base.SetAttribute<DateTime>(FieldModified, value); }
        }
    }
}
